...
<script setup name="KnowbaseDatasourceSingle">
  import { listKnowbaseDatasource } from "@/api/knowbase/struct/knowbaseDatasource";
  import { ref } from "vue";
  ...
  function getList() {
    loading.value = true;
    listKnowbaseDatasource(proxy.addDateRange(queryParams.value, daterangeCreateTime.value)).then(
        async (response) => {
