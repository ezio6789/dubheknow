...
<script setup name="KnowledgeSingle">
  import { listKnowledge } from "@/api/graph/manager/knowledge";
  import { ref } from "vue";
  ...
  function getList() {
    loading.value = true;
    listKnowledge(proxy.addDateRange(queryParams.value, daterangeCreateTime.value)).then(
        async (response) => {
