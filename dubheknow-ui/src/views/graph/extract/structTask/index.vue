<template>
  <div class="app-container" ref="app-container">
    ...
    <div  class="pagecont-bottom">
     <div class="justify-between mb15">
       <el-row :gutter="15" class="btn-style">
         <el-col :span="1.5">
           <el-button type="primary" plain @click="handleAdd" v-hasPermi="['graph:extract:structtask:add']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xinzeng mr5"></i>新增
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="primary" plain :disabled="single" @click="handleUpdate" v-hasPermi="['graph:extract:structtask:edit']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xiugai--copy mr5"></i>修改
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="danger" plain :disabled="multiple" @click="handleDelete" v-hasPermi="['graph:extract:structtask:remove']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-shanchu-huise mr5"></i>删除
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="info" plain  @click="handleImport" v-hasPermi="['graph:extract:structtask:export']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-upload-cloud-line mr5"></i>导入
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="warning" plain @click="handleExport" v-hasPermi="['graph:extract:structtask:export']"
                      @mousedown="(e) => e.preventDefault()">
     ...
     <el-table stripe height="58vh" v-loading="loading" :data="structTaskList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
       ...
       <el-table-column v-if="getColumnVisibility(5)" label="发布时间" align="center" prop="publishTime" width="180">
         <template #default="scope">
           <span>{{ parseTime(scope.row.publishTime, '{y}-{m}-{d}') }}</span>
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(6)" label="发布人id" align="center" prop="publisherId">
         <template #default="scope">
       ...
       <el-table-column v-if="getColumnVisibility(8)" label="数据源id" align="center" prop="datasourceId">
         <template #default="scope">
           {{ scope.row.datasourceId || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(9)" label="数据源名称" align="center" prop="datasourceName">
         <template #default="scope">
       ...
       <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
         <template #default="scope">
           <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                      v-hasPermi="['graph:extract:structtask:edit']">修改</el-button>
           <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                      v-hasPermi="['graph:extract:structtask:remove']">删除</el-button>
           <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"
                      v-hasPermi="['graph:extract:structtask:query']">详情</el-button>
           <el-button link type="primary" icon="view" @click="routeTo('/graph/extract/structTaskDetail',scope.row)"
                      v-hasPermi="['graph:extract:structtask:query']">复杂详情</el-button>
         </template>
       </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="800px" :append-to="$refs['app-container']" draggable>
      ...
      <el-form ref="structTaskRef" :model="form" :rules="rules" label-width="80px" @submit.prevent>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="知识库id" prop="knowledgeId">
        ...
        <template #tip>
          <div class="el-upload__tip text-center">
            <div class="el-upload__tip">
              <el-checkbox v-model="upload.updateSupport" />是否更新已经存在的结构化抽取任务数据
            </div>
...
<script setup name="StructTask">
  ...
  const upload = reactive({
    ...
    // 上传的地址
    url: import.meta.env.VITE_APP_BASE_API + "/graph/structTask/importData"
  });
  ...
  function importTemplate() {
    ...
    }, `structTask_template_${new Date().getTime()}.xlsx`)
  }
