<template>
  <div class="app-container" ref="app-container">
    <div class="pagecont-top" v-show="showSearch">
     <el-form class="btn-style" :model="queryParams" ref="queryRef" :inline="true" label-width="75px" v-show="showSearch" @submit.prevent>
      ...
      <el-form-item label="段落标识" prop="paragraphIndex">
        <el-input
            class="el-form-input-width"
            v-model="queryParams.paragraphIndex"
            placeholder="请输入段落标识"
            clearable
            @keyup.enter="handleQuery"
        />
    ...
    <div  class="pagecont-bottom">
     <div class="justify-between mb15">
       <el-row :gutter="15" class="btn-style">
         <el-col :span="1.5">
           <el-button type="primary" plain @click="handleAdd" v-hasPermi="['graph:extract:unstructtasktext:add']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xinzeng mr5"></i>新增
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="primary" plain :disabled="single" @click="handleUpdate" v-hasPermi="['graph:extract:unstructtasktext:edit']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xiugai--copy mr5"></i>修改
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="danger" plain :disabled="multiple" @click="handleDelete" v-hasPermi="['graph:extract:unstructtasktext:remove']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-shanchu-huise mr5"></i>删除
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="info" plain  @click="handleImport" v-hasPermi="['graph:extract:unstructtasktext:export']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-upload-cloud-line mr5"></i>导入
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="warning" plain @click="handleExport" v-hasPermi="['graph:extract:unstructtasktext:export']"
                      @mousedown="(e) => e.preventDefault()">
     ...
     <el-table stripe height="58vh" v-loading="loading" :data="unstructTaskTextList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
       ...
       <el-table-column v-if="getColumnVisibility(2)" label="文件id" align="center" prop="docId">
         <template #default="scope">
           {{ scope.row.docId || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(3)" label="段落标识" align="center" prop="paragraphIndex">
         <template #default="scope">
           {{ scope.row.paragraphIndex || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(4)" label="文字内容" align="center" prop="text">
         <template #default="scope">
           {{ scope.row.text || '-' }}
         </template>
       </el-table-column>
       ...
       <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
         <template #default="scope">
           <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                      v-hasPermi="['graph:extract:unstructtasktext:edit']">修改</el-button>
           <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                      v-hasPermi="['graph:extract:unstructtasktext:remove']">删除</el-button>
           <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"
                      v-hasPermi="['graph:extract:unstructtasktext:query']">详情</el-button>
           <el-button link type="primary" icon="view" @click="routeTo('/graph/extract/unstructTaskTextDetail',scope.row)"
                      v-hasPermi="['graph:extract:unstructtasktext:query']">复杂详情</el-button>
         </template>
       </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="800px" :append-to="$refs['app-container']" draggable>
      ...
      <el-form ref="unstructTaskTextRef" :model="form" :rules="rules" label-width="80px" @submit.prevent>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="任务id" prop="taskId">
        ...
        <template #tip>
          <div class="el-upload__tip text-center">
            <div class="el-upload__tip">
              <el-checkbox v-model="upload.updateSupport" />是否更新已经存在的任务文件段落关联数据
            </div>
...
<script setup name="UnstructTaskText">
  ...
  const upload = reactive({
    ...
    // 上传的地址
    url: import.meta.env.VITE_APP_BASE_API + "/graph/unstructTaskText/importData"
  });
  ...
  function importTemplate() {
    ...
    }, `unstructTaskText_template_${new Date().getTime()}.xlsx`)
  }
