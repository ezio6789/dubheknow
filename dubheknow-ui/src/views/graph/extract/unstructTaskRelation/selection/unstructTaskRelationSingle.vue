...
<script setup name="UnstructTaskRelationSingle">
  import { listUnstructTaskRelation } from "@/api/graph/extract/unstructTaskRelation";
  import { ref } from "vue";
  ...
  function getList() {
    loading.value = true;
    listUnstructTaskRelation(proxy.addDateRange(queryParams.value, daterangeCreateTime.value)).then(
        async (response) => {
