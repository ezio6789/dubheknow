<template>
  <div class="app-container" ref="app-container">
    ...
    <div  class="pagecont-bottom">
     <div class="justify-between mb15">
       <el-row :gutter="15" class="btn-style">
         <el-col :span="1.5">
           <el-button type="primary" plain @click="handleAdd" v-hasPermi="['graph:ontology:schemaattribute:add']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xinzeng mr5"></i>新增
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="primary" plain :disabled="single" @click="handleUpdate" v-hasPermi="['graph:ontology:schemaattribute:edit']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xiugai--copy mr5"></i>修改
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="danger" plain :disabled="multiple" @click="handleDelete" v-hasPermi="['graph:ontology:schemaattribute:remove']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-shanchu-huise mr5"></i>删除
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="info" plain  @click="handleImport" v-hasPermi="['graph:ontology:schemaattribute:export']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-upload-cloud-line mr5"></i>导入
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="warning" plain @click="handleExport" v-hasPermi="['graph:ontology:schemaattribute:export']"
                      @mousedown="(e) => e.preventDefault()">
     ...
     <el-table stripe height="58vh" v-loading="loading" :data="schemaAttributeList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
       <el-table-column type="selection" width="55" align="center" />
       <el-table-column v-if="getColumnVisibility(0)" label="ID" align="center" prop="id" />
       <el-table-column v-if="getColumnVisibility(1)" label="概念id" align="center" prop="schemaId">
         <template #default="scope">
           {{ scope.row.schemaId || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(2)" label="概念名称" align="center" prop="schemaName">
         <template #default="scope">
           {{ scope.row.schemaName || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(3)" label="属性名称" align="center" prop="name">
         <template #default="scope">
           {{ scope.row.name || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(4)" label="属性名称代码" align="center" prop="nameCode">
         <template #default="scope">
           {{ scope.row.nameCode || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(5)" label="是否必填" align="center" prop="requireFlag">
         <template #default="scope">
           {{ scope.row.requireFlag || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(6)" label="数据类型" align="center" prop="dataType">
         <template #default="scope">
           {{ scope.row.dataType || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(7)" label="单/多值" align="center" prop="multipleFlag">
         <template #default="scope">
           {{ scope.row.multipleFlag || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(8)" label="校验方式" align="center" prop="validateType">
         <template #default="scope">
           {{ scope.row.validateType || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(9)" label="最小值" align="center" prop="minValue">
         <template #default="scope">
           {{ scope.row.minValue || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(10)" label="最大值" align="center" prop="maxValue">
         <template #default="scope">
           {{ scope.row.maxValue || '-' }}
         </template>
       </el-table-column>
       ...
       <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
         <template #default="scope">
           <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                      v-hasPermi="['graph:ontology:schemaattribute:edit']">修改</el-button>
           <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                      v-hasPermi="['graph:ontology:schemaattribute:remove']">删除</el-button>
           <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"
                      v-hasPermi="['graph:ontology:schemaattribute:query']">详情</el-button>
           <el-button link type="primary" icon="view" @click="routeTo('/graph/ontology/schemaAttributeDetail',scope.row)"
                      v-hasPermi="['graph:ontology:schemaattribute:query']">复杂详情</el-button>
         </template>
       </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="800px" :append-to="$refs['app-container']" draggable>
      ...
      <el-form ref="schemaAttributeRef" :model="form" :rules="rules" label-width="80px" @submit.prevent>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="概念id" prop="schemaId">
...
<script setup name="SchemaAttribute">
  ...
  const upload = reactive({
    ...
    // 上传的地址
    url: import.meta.env.VITE_APP_BASE_API + "/graph/schemaAttribute/importData"
  });
  ...
  function importTemplate() {
    ...
    }, `schemaAttribute_template_${new Date().getTime()}.xlsx`)
  }
