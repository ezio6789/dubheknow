<template>
  ...
  >
    ...
    >
      ...
      <el-table-column label="实体名称列" align="center" prop="entityNameField">
        <template #default="scope">
...
<script setup name="SchemaMappingSingle">
  import { listSchemaMapping } from "@/api/graph/ontology/schemaMapping";
  import { ref } from "vue";
  ...
  function getList() {
    loading.value = true;
    listSchemaMapping(proxy.addDateRange(queryParams.value, daterangeCreateTime.value)).then(
        async (response) => {
