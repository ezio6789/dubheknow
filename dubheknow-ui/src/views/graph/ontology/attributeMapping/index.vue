<template>
  <div class="app-container" ref="app-container">
    ...
    <div  class="pagecont-bottom">
     <div class="justify-between mb15">
       <el-row :gutter="15" class="btn-style">
         <el-col :span="1.5">
           <el-button type="primary" plain @click="handleAdd" v-hasPermi="['graph:ontology:attributemapping:add']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xinzeng mr5"></i>新增
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="primary" plain :disabled="single" @click="handleUpdate" v-hasPermi="['graph:ontology:attributemapping:edit']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xiugai--copy mr5"></i>修改
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="danger" plain :disabled="multiple" @click="handleDelete" v-hasPermi="['graph:ontology:attributemapping:remove']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-shanchu-huise mr5"></i>删除
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="info" plain  @click="handleImport" v-hasPermi="['graph:ontology:attributemapping:export']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-upload-cloud-line mr5"></i>导入
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="warning" plain @click="handleExport" v-hasPermi="['graph:ontology:attributemapping:export']"
                      @mousedown="(e) => e.preventDefault()">
     ...
     <el-table stripe height="58vh" v-loading="loading" :data="attributeMappingList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
       ...
       <el-table-column v-if="getColumnVisibility(6)" label="属性id" align="center" prop="attributeId">
         <template #default="scope">
           {{ scope.row.attributeId || '-' }}
         </template>
       </el-table-column>
       <el-table-column v-if="getColumnVisibility(7)" label="属性名称" align="center" prop="attributeName">
         <template #default="scope">
       ...
       <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
         <template #default="scope">
           <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                      v-hasPermi="['graph:ontology:attributemapping:edit']">修改</el-button>
           <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                      v-hasPermi="['graph:ontology:attributemapping:remove']">删除</el-button>
           <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"
                      v-hasPermi="['graph:ontology:attributemapping:query']">详情</el-button>
           <el-button link type="primary" icon="view" @click="routeTo('/graph/ontology/attributeMappingDetail',scope.row)"
                      v-hasPermi="['graph:ontology:attributemapping:query']">复杂详情</el-button>
         </template>
       </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="800px" :append-to="$refs['app-container']" draggable>
      ...
      <el-form ref="attributeMappingRef" :model="form" :rules="rules" label-width="80px" @submit.prevent>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="任务id" prop="taskId">
...
<script setup name="AttributeMapping">
  ...
  const upload = reactive({
    ...
    // 上传的地址
    url: import.meta.env.VITE_APP_BASE_API + "/graph/attributeMapping/importData"
  });
  ...
  function importTemplate() {
    ...
    }, `attributeMapping_template_${new Date().getTime()}.xlsx`)
  }
