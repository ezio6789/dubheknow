<template>
  <div class="justify-between mb15">
    <el-row :gutter="15" class="btn-style">
      <el-col :span="1.5">
        <el-button type="primary" plain @click="handleAdd" v-hasPermi="['ontology:relationMapping:add']"
                   @mousedown="(e) => e.preventDefault()">
          <i class="iconfont-mini icon-xinzeng mr5"></i>新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain @click="handleExport" v-hasPermi="['ontology:relationMapping:export']"
                   @mousedown="(e) => e.preventDefault()">
  ...
  <el-table stripe height="374px" v-loading="loading" :data="relationMappingList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
    <el-table-column type="selection" width="55" align="center" />
            ...
            <el-table-column v-if="columns[6].visible" label="关系" align="center" prop="relation">
              <template #default="scope">
                {{ scope.row.relation || '-' }}
              </template>
            </el-table-column>
            <el-table-column v-if="columns[7].visible" label="关联表" align="center" prop="relationTable">
              <template #default="scope">
                {{ scope.row.relationTable || '-' }}
              </template>
            </el-table-column>
            <el-table-column v-if="columns[8].visible" label="关联表名称" align="center" prop="relationTableName">
              <template #default="scope">
                {{ scope.row.relationTableName || '-' }}
              </template>
            </el-table-column>
            <el-table-column v-if="columns[9].visible" label="关联表字段" align="center" prop="relationField">
              <template #default="scope">
                {{ scope.row.relationField || '-' }}
              </template>
            </el-table-column>
            <el-table-column v-if="columns[10].visible" label="关联表实体字段" align="center" prop="relationNameField">
              <template #default="scope">
    ...
    <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
      <template #default="scope">
        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                   v-hasPermi="['ontology:relationMapping:edit']">修改</el-button>
        <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                   v-hasPermi="['ontology:relationMapping:remove']">删除</el-button>
        <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"
                   v-hasPermi="['ontology:relationMapping:edit']">详情</el-button>
      </template>
    </el-table-column>
  ...
  <el-dialog :title="title" v-model="open" width="800px" :append-to="$refs['app-container']" draggable>
    ...
    <el-form ref="relationMappingRef" :model="form" :rules="rules" label-width="80px">
                    <el-row :gutter="20">
                      <el-col :span="12">
...
<script setup name="ComponentOne">
  ...
  const { queryParams, form, relationMappingDetail, rules } = toRefs(data);
