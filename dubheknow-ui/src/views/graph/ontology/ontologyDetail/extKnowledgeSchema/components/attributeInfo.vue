      ...
      >
        ...
        <el-row :gutter="20">
          ...
          <!-- <el-col :span="12">
            <el-form-item
              :label="
                (+form.dataType === 6 || +form.dataType === 7) &&
                ext_data_type.find((item) => +item.value === +form.dataType)
                  ?.label
              "
              label-width="auto"
            >
              <el-upload
                v-if="+form.dataType === 6"
                class="upload-demo"
                accept=".xlsx, .xls"
                name="file"
                :headers="uploadAttachment.headers"
                :action="uploadAttachment.url"
                :disabled="uploadAttachment.isUploading"
              ...
              <el-select v-else-if="+form.dataType === 7">
                <el-option></el-option>
              </el-select>
            </el-form-item>
          </el-col> -->
...
watch(
  () => props,
  (newVal) => {
    receptionId = newVal.nodeData.id;
    receptionName = newVal.nodeData.name;
    getList();
  },
  { deep: true }
);
