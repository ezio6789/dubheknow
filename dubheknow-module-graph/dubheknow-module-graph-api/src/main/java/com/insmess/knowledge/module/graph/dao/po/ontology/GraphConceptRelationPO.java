...
/**
 * 关系配置 PO 对象 graph_concept_relation
 *
 * @author insmess
 * @date 2025-11-29
 */
@Data
@TableName(value = "graph_concept_relation")
// 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
// @KeySequence("graph_concept_relation_seq")
@Builder
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class GraphConceptRelationPO extends BaseEntity {
