...
public interface DbQuery {
    ...
    /**
     * 执行SQL查询，并为每个表的字段名添加表别名前缀。
     * 示例：SELECT a.*, b.* FROM facility a INNER JOIN build_type b ON a.type = b.id;
     * 输出字段名：a_id, a_name, b_id, b_type, ...
     */
    List<Map<String, Object>> queryWithAliasPrefix(String tableA, String tableB, String joinCondition);
