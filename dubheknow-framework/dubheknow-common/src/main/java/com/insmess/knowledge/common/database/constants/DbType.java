package com.insmess.knowledge.common.database.constants;
...
public enum DbType {
     ...
     * MARIADB
     */
    MARIADB("MariaDB", "MariaDB数据库", "jdbc:mariadb://${host}:${port}/${dbName}", "CHAR_LENGTH"),
    /**
     * ORACLE
     */
     ...
     * POSTGRESQL
     */
    POSTGRE_SQL("PostgreSql", "PostgreSql数据库", "jdbc:postgresql://${host}:${port}/${dbName}", "LENGTH"),
    /**
     * SQLSERVER2005
     */
    SQL_SERVER2008("SQLServer2008-", "SQLServer2008及以下数据库", "jdbc:sqlserver://${host}:${port};DatabaseName=${dbName}", "LEN"),
    /**
     * SQLSERVER
     */
    SQL_SERVER("SQLServer2012+", "SQLServer2012+数据库", "jdbc:sqlserver://${host}:${port};DatabaseName=${dbName}", "LEN"),
    /**
     * UNKONWN DB
     */
    OTHER("Other", "其他数据库", "", "LENGTH"),
    /**
     * 达梦8
     */
     ...
     * 南大通用
     */
    GBASE("GBase", "南大通用", "jdbc:gbase://${host}:${port}/${dbName}", "LENGTH");
