package com.insmess.knowledge.generator.util;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import org.apache.velocity.VelocityContext;
import com.insmess.knowledge.common.constant.GenConstants;
import com.insmess.knowledge.common.core.domain.entity.SysDictData;
import com.insmess.knowledge.common.core.domain.entity.SysDictType;
import com.insmess.knowledge.common.utils.DateUtils;
import com.insmess.knowledge.common.utils.StringUtils;
import com.insmess.knowledge.generator.domain.GenTable;
import com.insmess.knowledge.generator.domain.GenTableColumn;
...
public class VelocityUtils
{
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        {
            fileName = StringUtils.format("{}/api/dao/po/{}/{}.java", javaPath, moduleName, className + "PO");
        }
        if (template.contains("respVO.java.vm"))
        {
            fileName = StringUtils.format("{}/api/vo/{}/{}.java", javaPath, moduleName, className + "RespVO");
        }
        if (template.contains("pageReqVO.java.vm"))
        {
            fileName = StringUtils.format("{}/api/vo/{}/{}.java", javaPath, moduleName, className + "PageReqVO");
        }
        ...
        {
            fileName = StringUtils.format("{}/api/vo/{}/{}.java", javaPath, moduleName, className + "SaveReqVO");
        }
        if (template.contains("sub-po.java.vm") && StringUtils.equals(GenConstants.TPL_SUB, genTable.getTplCategory()))
        {
            fileName = StringUtils.format("{}/domain/{}.java", javaPath, genTable.getSubTable().getClassName());
        }
        else if (template.contains("mapper.java.vm"))
        {
            fileName = StringUtils.format("{}/biz/dao/mapper/{}/{}Mapper.java", javaPath, moduleName, className);
        }
        else if (template.contains("service.java.vm"))
        {
            fileName = StringUtils.format("{}/api/service/{}/{}Service.java", javaPath, moduleName, className);
        }
        ...
        {
            fileName = StringUtils.format("{}/biz/controller/{}/{}Controller.java", javaPath, moduleName, className);
        }
        ...
        {
            fileName = StringUtils.format("{}/views/{}/{}/{}/index.vue", vuePath, javaPath.substring(javaPath.lastIndexOf("/") + 1), moduleName, businessName);
        }
        ...
        {
            fileName = StringUtils.format("{}/views/{}/{}/{}/selection/{}Single.vue", vuePath, javaPath.substring(javaPath.lastIndexOf("/") + 1), moduleName, businessName, businessName);
        }
        else if (template.contains("multiple-selection.vue.vm"))
        {
            fileName = StringUtils.format("{}/views/{}/{}/{}/selection/{}Multiple.vue", vuePath, javaPath.substring(javaPath.lastIndexOf("/") + 1), moduleName, businessName, businessName);
        }
        else if (template.contains("complex-detail.vue.vm"))
        {
            fileName = StringUtils.format("{}/views/{}/{}/{}/detail/index.vue", vuePath, javaPath.substring(javaPath.lastIndexOf("/") + 1), moduleName, businessName);
        }
        else if (template.contains("componentOne.vue.vm"))
        {
            fileName = StringUtils.format("{}/views/{}/{}/{}/detail/componentOne.vue", vuePath, javaPath.substring(javaPath.lastIndexOf("/") + 1), moduleName, businessName);
        }
        else if (template.contains("componentTwo.vue.vm"))
        {
            fileName = StringUtils.format("{}/views/{}/{}/{}/detail/componentTwo.vue", vuePath, javaPath.substring(javaPath.lastIndexOf("/") + 1), moduleName, businessName);
        }
        return fileName;
    }
