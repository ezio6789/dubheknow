...
public class Neo4jBuildWrapper<T> {
     ...
     * @return
     */
    public String updateQuery(String label,
        ...
        //添加移除标签语句
        if (CollUtil.isNotEmpty(removeLabels)) {
            query.append(" REMOVE n:").append(String.join(",", removeLabels));
        }
        ArrayList<String> listByMap = new ArrayList<>();
        if (CollUtil.isNotEmpty(addLabels)) {
            String labelStr = "n" + ":";
            labelStr += String.join(":", addLabels);
            listByMap.add(labelStr);
        }

        if (updateMap != null &&updateMap.size() > 0) {
            listByMap.addAll(getUpdateListByMap("n",updateMap));
...
//        query.append(" RETURN n");
    ...
    public String updateQuery(String label,
                              ...
                              Map<String, Object> updateMap,
                              List<String> addLabels) {
        return updateQuery(label, paramMap, updateMap, addLabels, null);
//        ArrayList<String> arrayList = getUpdateListByMap("n",paramMap);
//        StringBuilder query = new StringBuilder("MATCH (n:" + label + ")");
//        if(paramMap.get("id") != null){
//            query.append(" WHERE ID(n) = ").append(paramMap.get("id"));
...
//        return query.toString();
    ...
    public String updateQuery(String label, Map<String, Object> paramMap, Map<String, Object> updateMap) {
        return updateQuery(label, paramMap, updateMap, null);
//        ArrayList<String> arrayList = getUpdateListByMap("n",paramMap);
//        StringBuilder query = new StringBuilder("MATCH (n:" + label + ")");
//        if(paramMap.get("id") != null){
//            query.append(" WHERE ID(n) = ").append(paramMap.get("id"));
...
//        return query.toString();
    ...
    public String mergeCreateNode(String label, Map<String, Object> mergeMap, Map<String, Object> attributeMap) {
        return mergeCreateNode(label, mergeMap, attributeMap, null);
    }
     ...
     * @return
     */
    public String mergeCreateNode(String label, Map<String, Object> mergeMap, Map<String, Object> attributeMap, String newLabel) {
