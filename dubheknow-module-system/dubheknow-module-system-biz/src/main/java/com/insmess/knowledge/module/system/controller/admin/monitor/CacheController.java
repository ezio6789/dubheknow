...
import com.insmess.knowledge.module.system.domain.SysCache;
...
public class CacheController
{
    ...
    public AjaxResult getCacheValue(@PathVariable("cacheName") String cacheName, @PathVariable("cacheName") String cacheKey)
    {
